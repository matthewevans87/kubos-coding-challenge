import { MemoryBackedDataStoreService } from "./DataStoreService";
import { Telemetry } from "../models/Telemetry";

test('Should handle example data', () => {
    const ds = new MemoryBackedDataStoreService();
